...
export default function App() {
  ...
  const generate = async () => {
    ...
    const userMsg = `Tagesplan für heute ${getToday()}.
Beruf: ${berufLabel}
Level: ${answers.level}
Fokus heute: ${answers.fokus}
PIE-Rotation: Wähle automatisch zwischen P / I / E — sorge über mehrere Tage für eine gleichmäßige Mischung. Heute wählst du was am besten passt.
Erstelle einen frischen konkreten Plan — zugeschnitten auf diese Person und ihre Zielgruppe.`;
          ...
          <div>
            ...
            <div style={S.rcrd}>
              ...
              <div style={S.rbody}>
                ...
                <div style={{ marginBottom: 8, color: "#555" }}><strong style={{ color: "#999", fontSize: 11, textTransform: "uppercase", letterSpacing: 1 }}>Inhalt </strong><br />{result.content?.inhalt}</div>
                <div style={{ color: "#555" }}><strong style={{ color: "#cc3333", fontSize: 11, textTransform: "uppercase", letterSpacing: 1 }}>CTA </strong><br />{result.content?.cta}</div>
              </div>
            </div>
